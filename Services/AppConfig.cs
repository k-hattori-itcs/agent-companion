...
public class AppConfig
{
    ...
    private static readonly string JsonPath = AppDataPaths.ConfigJsonPath;
    private static readonly string CfgPath = AppDataPaths.ConfigCfgPath;
    ...
    public double? ClaudeFiveHourUsagePercent { get; set; }
    public DateTimeOffset? ClaudeFiveHourResetsAt { get; set; }
    ...
    private void CopyFrom(AppConfig other)
    {
        ...
        ClaudeFiveHourUsagePercent = other.ClaudeFiveHourUsagePercent;
        ClaudeFiveHourResetsAt = other.ClaudeFiveHourResetsAt;
