...
- v2キャラクターパッケージは、既存キャラクターを置き換える前にスプライトアトラスの構成を検証します。
- v2形式は 1536x2288px、1セル192x208px、8列11行を必須とし、標準9動作は rows 0〜8 に配置します。
- Natsuki の同梱アトラスとインポート時のメタデータ保持を自動テストで検証しています。
