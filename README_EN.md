...
- Re-imports an updated character ZIP with the same ID without restarting AgentCompanion.
- Reloads spritesheets and preview images immediately, even while Settings remains open.
